...
--
ALTER TABLE `item`
  MODIFY `id_item` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de tabela `mage`
--
ALTER TABLE `mage`
  MODIFY `id_mage` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de tabela `warrior`
--
ALTER TABLE `warrior`
  MODIFY `id_warrior` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
COMMIT;
