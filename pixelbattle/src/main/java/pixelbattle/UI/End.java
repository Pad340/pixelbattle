...
public class End extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(50, 0, 800, 160);
        ...
        winnerImage.setBounds(310, 250, 270, 320);

        backgroundGif.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        backgroundGif.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pixelbattle/UI/images/backgroundEscolhaPersonagem.png"))); // NOI18N
        getContentPane().add(backgroundGif);
        backgroundGif.setBounds(0, -10, 900, 670);
